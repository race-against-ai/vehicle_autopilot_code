...
class LaneDetection:
    def __init__(self):
        ...
        width = 1024
        height = 768
        self.orig_image_size = [width,height]
        self.width = width
        self.height = height
...
def main_lanes(frame, lane_detection, debug):
    ...
    cv2.imwrite("curve.png", cropped_image)
    ...
    left_counts, right_counts = lane_detection.find_nearest_white_pixels([767, 630, 536, 441, 353, 58])

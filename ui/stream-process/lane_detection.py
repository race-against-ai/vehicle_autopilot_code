...
class LaneDetection:
    ...
    def select_rows_black_rest(self, frame):
        """
    ...
    def dashed_side(self, printToTerminal, curve):
        ...
        return distance_left, distance_right, info_left, info_right, distance_left, distance_right
...
def main_lanes(frame, lane_detection, debug, placeholder):
    ...
    blacked_image = lane_detection.select_rows_black_rest(frame)
    ...
    transformed_images = lane_detection.perspective_transform(blacked_image, False)
    ...
    distance_left, distance_right, info_left, info_right, distance_left, distance_right = lane_detection.dashed_side(debug, curve)
    ...
    return center_offset, data_time, curve, speed, transformed_images, data_car
